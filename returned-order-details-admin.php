                        ...
                        <div class="about-section">
                            <div class="container">
                              <div class="row">
                                ...
                                <button class="btn btn-primary mb-3" onclick="window.location.href='generate_pdf_returned.php?order_id=<?= $orderID ?>'">Print Order Slip</button>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="address-box" align="left">
                                    ...
                                    <p><strong>Returned Date:</strong> <?= $order['date_delivered'] == '0000-00-00 00:00:00' ? 'Not Yet' : date('F j, Y', strtotime($order['date_delivered'])); ?></p>
