  ...
  <div class="products" style="margin: 50px;" >
    ...
    <div class="row">
        <div class="col-md-2 custom-sidebar">
            ...
            <a href="#" data-target="account-details">Account details</a>
        ...
        <div class="col-md-10 custom-content">
            <div id="dashboard" class="content-section">
                ...
                $userQuery = "SELECT full_name FROM site_user WHERE id = ?";
                ...
                if ($userResult && mysqli_num_rows($userResult) > 0) {
                    ...
                    $userFullName = $userRow['full_name'];
                }
                 ...
                 ?>
                   ...
                   <div align="center" style="margin-top: 50px;">
                      <div class="status1" style="display: inline-block; margin-right: 80px;">
                        <a href="mypending-orders.php" style="text-decoration:none">
                          <h1>
                              <span>
                                  <!-- Icon for pendings -->
                                  <i class="bi bi-wallet2" style="color: black; font-size: 2em;"></i>
                                  <p style="font-size: 1em;color: black;" >To be paid</p>
                              </span>
                          </h1>
                           </a>       
                      </div>
                      <div class="status1" style="display: inline-block; margin-right: 80px;">
                        <a href="myshipping.php" style="text-decoration:none">
                          <h1>
                              <span>
                                  <!-- Icon for shipping -->
                                  <i class="bi bi-truck" style="color: black; font-size: 2em;"></i>
                                  <p style="font-size: 1em;color: black;">Shipping</p>
                              </span>
                          </h1>
                           </a>       
                      </div>
                      <div class="status1" style="display: inline-block;">
                          <a href="mydelivered-orders.php" style="text-decoration:none">
                          <h1>
                              <span>
                                  <!-- Icon for completed -->
                                  <i class="bi bi-bag-check" style="color: black; font-size: 2em;"></i>
                                  <p style="font-size: 1em;color: black;">Completed</p>
                              </span>
                          </h1>
                          </a>      
                      </div>
            ...
            <div id="orders" class="content-section hidden">
                ...
                $query = "SELECT * FROM orders WHERE user_id = ? ORDER BY order_date ASC";
                $stmt = mysqli_prepare($conn, $query);
                mysqli_stmt_bind_param($stmt, "i", $userID);
                mysqli_stmt_execute($stmt);
                $result = mysqli_stmt_get_result($stmt);
            ...
            <div id="addresses" class="content-section hidden">
                ...
                <p>The following addresses will be used on the checkout page by default.</p>
                    ...
                    <div class="col-md-6">
                        <div class="address-box">
                            <h4>Shipping address <a href="add_address.php">Add</a></h4>
                            <p>You want to add another Address?.</p>
                        </div>
                    </div>
                </div>
                <div id="account-details" class="content-section hidden">
    <?php
    ...
    <div>
        <form action="update-password.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($userInfo['username']); ?>" readonly>
            </div>
            <div class="form-group">
                <label for="fullname">Full Name:</label>
                <input type="text" id="fullname" name="fullname" value="<?php echo htmlspecialchars($userInfo['full_name']); ?>">
            </div>
            <div class="form-group">
                <label for="contact">Contact Number:</label>
                <input type="text" id="contact" name="contact" value="<?php echo htmlspecialchars($userInfo['contact_num']); ?>">
            </div>
            <div class="form-group">
