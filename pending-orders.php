    ...
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        <div class="log-button">
            <button class="log-out"><a href="log_out.php" style="text-decoration:none; color: white;">Log Out</a></button>
                    ...
                    <div class="main">
                        ...
                        <input class="form-control me-2" type="search" placeholder="Search by Status" id="searchStatusInput">
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        function addViewDetailsEventListeners() {
            document.querySelectorAll('.edit-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    window.location.href = `order-details-admin.php?order_id=${order_id}`;
                });
            });
        }
        ...
        document.getElementById('searchStatusInput').addEventListener('input', handleSearch);
