...
<main style="background-color: ghostwhite; padding-bottom: 180px; margin-right: 20px; margin-left: 20px; margin-top: 30px;">
  <br>
  ...
  <h2 align="center" style=" margin-bottom: 0px; font-family: arial;font-weight: bold;">NEW ARRIVALS</h2>
      ...
      <div class="thank-you-container">
        ...
        <h6>"Where Every Shoe is a Perfect Fit at DimeFootwear"</h6>
    </div>
</main>
