            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color: #443f38;">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            ...
                            <ul class="collapse nav flex-column ms-1 show" id="submenu3" data-bs-parent="#menu">
                                <li class="w-100">
                                    <a href="#" class="nav-link px-0"> <i class="bi bi-plus"></i> <span class="d-none d-sm-inline">Add Product</span> </a>
                                </li>
                                <li class="w-100">
                    ...
                    <div class="log-button">                        
                        <button class="log-out"><a href="loh_out.php" style="text-decoration:none; color: white;">Log Out</a></button>
                    </div>
                </div>
            </div>
            <div class="col py-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchProducts() {
                ...
                fetch(`search.php?searchName=${searchName}&searchSerial=${searchSerial}`)
                            ...
                            data.forEach(product => {
                                ...
                                row.innerHTML = `
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-success">Add Stocks</button>
