...
<form action="add_address" method="POST">
  ...
  <label class="field">
    <span class="field__label" for="address">CONTACT NUMBER</span>
    <input class="field__input" type="number" id="address" />
  </label>
  ...
  <label class="field">
    <span class="field__label" for="country">Region</span>
    <select class="field__input" id="Region">
              ...
              <option value="Region IX">Zamboanga Peninsula (Region X)</option>
              <option value="Region X">Northern Mindanao (Region 13)</option>
              <option value="Region XI">Davao Region (Region XI)</option>
              <option value="Region XII">SOCCSKSARGEN (Region 15)</option>
